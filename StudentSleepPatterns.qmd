...
We wanted to create a whollistic analysis regarding the correlation of physical activity and students' sleep duration, regardless of student year. To find this, we proposed the following research question: - Is there a significant interaction between physical activity and sleep duration?
...
-   In addition, this could also be due to the synthetic nature of the dataset we are analyzing, which, even if it draws from existing measured attributes of sleep duration and physical activity, might not be a perfect represenation of these variables, and may thus skew our findings and their applicability to real-world scenarios.

## Research Question 4

In this final visualization, we are concerned with seeing how two attributes (University Year and Sleep Duration) are related and potentially seeking out any correlations between the two. In the previous visualizations, the focus has primarily been looking at general avergaes across university years or a direct comparison between a group of classes, but here we want to see a statistical summarization to include other measures of central tendency and ranges between the university classes.
...
To best visualize this relationship, we thought that a side by side comparision of a box plot with the following five measures: Minimum, Q1, Median, Q3, and Maximum, would be best. Seeing that direct comparison between  The x axis shows the respective year while the Y axis shows the hours. The measures are clearly demarcated by the dark blue outlines, while the light blue highlights where 50% of the data closest to the median lies. This is important to understand where the majority of people lie within the class, and creates way for a more holistic comparision between the multiple university classes. 
...
-  The median sleep duration does not vary too much across the years, central tendency is fairly consistent for all university students.

-  For second and third year students, the range is more narrow, so they tend to have more consistency in their sleep patterns. 

-  There are no significant outliers in the dataset, which means there is consistnecy amongst most students in their respective cohort

-  The second and third year students likely have stability in their morkloads and schedules, meaning the ranges are narrower. For first or third year students it can be different due to initial adjustments or final years being held to various kinds of workloads due to the nearing of graduation or finding a job

# Conclusion

In this project, we took into consideration how (synthetic) data to see how a studen'ts sleep patterns are everchanging through the challenging years of college. Our results showed nuanced and intercorrelated insights to both student life, and how it may change and ultimately affect a student's quality of sleep.

Sleep Patterns

As a student transitions to the next year, we see general decreases in average sleep duration. This gradual decline is likely attributed to greater acacdemic obligations or potentially demanding lfiestyle changes and prioritization. 

Physical Activity Trends

Physical activity was, interestingly enough, high in upperclassmen than underclassmen. This may indicate a greater sense of time management and school-life balance that comes with experience in college.

Beyond the Numbers

While there is not evidently a strong correlation between sleep and physical activity, our vizualizations and research suggests that individual factors like lifestyle choices, priorities of academia over other things, and intrapersonal skills like time management likely have a more significant impact on the way student's go about their lives.
It sheds light on how undergraduate students' health behaviors subtly differ throughout their journey in school, emphasizign that the interplay between academic life and personal life is a unique and important balance to strike for overall well-being.
